...
export default (props) => {
    ...
    return <div
        className={"flex justify-center items-center shadow animated faster fadeIn overflow-hidden " + (fFull ?"fixed top-0 left-0 z-10":("absolute "+props.Rounded))}
style={{
        ...
        <div className="w-full h-full flex flex-col justify-center items-center overflow-hidden">
            <div className={"w-full h-6 p-1 flex-none flex items-center " + (fFull ? "absolute top-0 left-0 opacity-0 hover:opacity-100 hover:relative justify-end" : "shadow justify-center")}>
                ...
                <div className={"ri-subtract-line flex-none text-sm flex items-center justify-center cursor-pointer bg-orange-400 h-4 w-4 text-gray-200 hover:shadow hover:bg-orange-500 mr-1 "+props.Rounded}/>
                <div onClick={() => {
                    setFMax(!fMax)
                }} className={"flex-none text-xs flex items-center justify-center cursor-pointer" +
                " bg-blue-400 h-4 w-4 text-gray-200 hover:shadow hover:bg-blue-500 mr-1 "+props.Rounded+" " + (fMax ? "ri-checkbox-multiple-blank-line" : "ri-checkbox-blank-line")}/>
                <div onClick={() => {
                    setFFull(!fFull)
                }} className={"flex-none text-xs flex items-center justify-center cursor-pointer" +
                " bg-green-400 h-4 w-4 text-gray-200 hover:shadow hover:bg-green-500 mr-1 "+props.Rounded+" " + (fFull ? "ri-checkbox-multiple-blank-line" : "ri-checkbox-blank-line")}/>
                <div className={"ri-close-line flex-none text-sm flex items-center justify-center cursor-pointer bg-red-500 h-4 w-4 text-gray-200 hover:shadow hover:bg-red-600 mr-1 "+props.Rounded}/>
            </div>
